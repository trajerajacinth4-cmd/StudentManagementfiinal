        ...
        <div class="card-body">
            ...
            <form action="{{ route('students.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="course" class="form-control" value="{{ old('course') }}" placeholder="Computer Science" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Age</label>
                    <input type="number" name="age" class="form-control" value="{{ old('age') }}" placeholder="20" required>
                </div>
