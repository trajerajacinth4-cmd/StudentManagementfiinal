        ...
        <div class="card card-custom border-0 overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Profile Photo / Avatar File Upload -->
                    <div class="mb-3">
                        <label for="avatar" class="form-label fw-semibold text-secondary">Profile Picture / Avatar</label>
                        <div class="input-group">
                            <span class="input-group-text bg-indigo-subtle border-end-0"><i class="bi bi-image text-indigo icon-md"></i></span>
                            <input type="file" name="avatar" id="avatar" class="form-control" accept="image/*">
                        </div>
                        <div class="form-text small">Optional. Max file size: 2MB (JPEG, PNG, WEBP).</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="student_number" id="student_number" class="form-control" value="{{ old('student_number') }}" placeholder="Auto-generated if left blank (e.g. STD-2026-00100)">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="first_name" id="first_name" class="form-control" value="{{ old('first_name') }}" placeholder="e.g. John" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-indigo-subtle border-end-0"><i class="bi bi-person text-indigo icon-md"></i></span>
                                <input type="text" name="middle_name" id="middle_name" class="form-control" value="{{ old('middle_name') }}" placeholder="e.g. Mark">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-indigo-subtle border-end-0"><i class="bi bi-person text-indigo icon-md"></i></span>
                                <input type="text" name="last_name" id="last_name" class="form-control" value="{{ old('last_name') }}" placeholder="e.g. Mayo" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="e.g. john.doe@example.com" required>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select name="course" id="course" class="form-select" required>
                                    <option value="" disabled {{ old('course') ? '' : 'selected' }}>Choose a Managed Course...</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0.00" max="5.00" name="gpa" id="gpa" class="form-control" value="{{ old('gpa') }}" placeholder="e.g. 3.75">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="age" id="age" class="form-control" value="{{ old('age', 20) }}" placeholder="20" min="15" max="100" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm d-flex align-items-center gap-1.5">
                            <i class="bi bi-check-circle-fill icon-sm"></i> Save Student
                        </button>
                    </div>
                </form>
            </div>
