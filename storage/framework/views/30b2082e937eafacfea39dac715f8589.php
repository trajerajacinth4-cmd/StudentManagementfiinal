...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
    <div class="container">
        ...
        <div class="d-flex align-items-center">
            <span class="text-light me-3">Welcome, <strong><?php echo e(Auth::user()->name); ?></strong></span>
...
<div class="container mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Student List</h2>
        <div>
            <a href="<?php echo e(route('students.pdf')); ?>" class="btn btn-danger me-2">
            ...
            <table class="table table-striped table-hover mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="<?php echo e(route('students.destroy', $student->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this student?')">
                                    <?php echo csrf_field(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="text-center py-4 text-muted">No students found. <a href="<?php echo e(route('students.create')); ?>">Add one now</a>.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php /**PATH C:\laragon\www\StudentManagement\resources\views/students/index.blade.php ENDPATH**/ ?>